...
Almanack.config do |calendar|
  ...
  calendar.add_events [
    {
      title: "Hogswatch",
      start_time: now + Almanack::Calendar::ONE_DAY,
      end_time: now + Almanack::Calendar::ONE_DAY * 2,
    ...
    { title: "Soul Cake Tuesday", start_time: now + 10 * Almanack::Calendar::ONE_DAY },
    { title: "Eve of Small Gods", start_time: now + 30 * Almanack::Calendar::ONE_DAY },
  ]
end
